package com.fediim.fitmetrics.api.infrastructure

import com.fediim.fitmetrics.api.auth.*
...
open class ApiClient(
    ...
    companion object {
        const val BASE_URL: String = "https://api.fitbit.com"
    ...
    private fun URLBuilder.appendPath(components: kotlin.collections.List<String>): URLBuilder =
        apply {
            encodedPath = encodedPath.trimEnd('/') + components.joinToString("/", prefix = "/") {
