...
open class BreathingRateApi(
     ...
     * @return void
     */
    open suspend fun getBreathingRateSummaryByDate(date: java.time.LocalDate): HttpResponse<Unit> {
        ...
        val localVariableConfig =
            RequestConfig<kotlin.Any?>(
                RequestMethod.GET,
                "/1/user/-/br/date/{date}.json".replace("{" + "date" + "}", "$date"),
     ...
     * @return void
     */
    open suspend fun getBreathingRateSummaryByInterval(
        ...
        val localVariableConfig =
            RequestConfig<kotlin.Any?>(
                RequestMethod.GET,
                "/1/user/-/br/date/{startDate}/{endDate}.json".replace(
                    "{" + "startDate" + "}",
                    "$startDate"
