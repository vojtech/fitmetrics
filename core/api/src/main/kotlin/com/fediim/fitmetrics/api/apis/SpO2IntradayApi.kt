...
open class SpO2IntradayApi(
     ...
     * @return void
     */
    open suspend fun getSpO2IntradayByDate(date: java.time.LocalDate): HttpResponse<Unit> {
        ...
        val localVariableConfig =
            RequestConfig<kotlin.Any?>(
                RequestMethod.GET,
                "/1/user/-/spo2/date/{date}/all.json".replace("{" + "date" + "}", "$date"),
     ...
     * @return void
     */
    open suspend fun getSpO2IntradayByInterval(
        ...
        val localVariableConfig =
            RequestConfig<kotlin.Any?>(
                RequestMethod.GET,
                "/1/user/-/spo2/date/{startDate}/{endDate}/all.json".replace(
                    "{" + "startDate" + "}",
                    "$startDate"
