...
open class HeartRateVariabilityIntradayApi(
     ...
     * @return void
     */
    open suspend fun getHrvIntradayByDate(date: java.time.LocalDate): HttpResponse<Unit> {
        ...
        val localVariableConfig =
            RequestConfig<kotlin.Any?>(
                RequestMethod.GET,
                "/1/user/-/hrv/date/{date}/all.json".replace("{" + "date" + "}", "$date"),
     ...
     * @return void
     */
    open suspend fun getHrvIntradayByInterval(
        ...
        val localVariableConfig =
            RequestConfig<kotlin.Any?>(
                RequestMethod.GET,
                "/1/user/-/hrv/date/{startDate}/{endDate}/all.json".replace(
                    "{" + "startDate" + "}",
                    "$startDate"
